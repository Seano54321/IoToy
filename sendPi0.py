...
# Continually sets data from accelerometer readings and publishes to topics
while True:
    ...
    publish.single("sensors/accelerometer/data",'{0} {1} {2} {3:.2f} {4:.2f} {5} {6} {7} {8} {9} {10} {11}'.format(heading, roll, pitch, sys, gyro, accel, mag, x, y, z, w, magnitude),hostname="192.168.4.1" )
    publish.single("sensors/accelerometer/magnitude", magnitude, hostname="192.168.4.1")
